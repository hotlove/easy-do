...
<script lang="ts">
    ...
    export default class Music extends Vue {
        ...
        public circleLeft: any = null;
        public barWidth: any = null;
        public duration: any = null;
        public currentTime: any = null;
        public isTimerPlaying: boolean = false;
        ...
        public updateBar(x: any) {
            let progress: any = this.$refs.progress;
            let maxduration: any = this.audio.duration;
            let position: any = x - progress.offsetLeft;
            let percentage: any = (100 * position) / progress.offsetWidth;
            if (percentage > 100) {
                percentage = 100;
            }
            if (percentage < 0) {
        ...
        public created() {
            ...
            for (let element of this.tracks) {
